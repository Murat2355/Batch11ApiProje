...
public class GetRequest12 extends TestBaseDummy {
    ...
    public void get01(){
        ...
        //Butun yaslari iceren bir List OLusturuyoruz
        //Test case deki yaslar var mi yok mu cantainsAll methoduyla kontrol yapcaz.
        ...
        Assert.assertEquals(expectedDataList.get(5).get("AllDetailsAboutEmployee"),((List) actualDataMap.get("data")).get(10));//hepsini tek seferde yapti
        ...
        Assert.assertEquals(((Map)expectedDataList.get(5).get("AllDetailsAboutEmployee")).get("id"),(((Map)((List<?>) actualDataMap.get("data")).get(10)).get("id")));
