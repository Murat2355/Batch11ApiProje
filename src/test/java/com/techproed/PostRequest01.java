...
public class PostRequest01 extends TestBaseDummy {
	...
	*/
    ...
    public void post01(){
        ...
        //mesaj lari assert etmek icin once dummytestdata obje den methodu cagiracagiz
        //once Mao plusturalim.
        ...
        //2.yol GSON--DE Serialization ile
        ...
        //if (reqBodyMap.get("profile_image").equals("")){
        //            reqBodyMap.put("profile_image",null);
        //        } bunu yukarda kullandigimiz icin tekrara gerek yok cunku ayni scop ayni method dayiz
        //        direk assert edebiliriz.
        ...
        //3.yol JSonObject+jsonPath ile   onemli interviewlerde cok soruluyor;soft assert yapalım
        ...
        //softAssert.assertEquals(json.get("data.profile_image"),expectedDataJsonObject.get("profile_image"));//bu olmamisti buna bak sonra


        JSONObject messageJsonObject = expectedObj.setUpMessageDataByUsingJSONObject();
        System.out.println(messageJsonObject);
        softAssert.assertEquals(json.getString("message"),messageJsonObject.getString("message"));
        softAssert.assertEquals(json.getString("status"),messageJsonObject.getString("status"));
